		...
		http.
			cors()
				...
				.and()
					...
					.successHandler(this.authSuccess).failureHandler(this.authFailure).and().authorizeRequests()
				.antMatchers(HttpMethod.GET, "/**").permitAll().antMatchers(HttpMethod.POST, "/**/account/create")
				.permitAll().antMatchers(HttpMethod.POST, "/**/account/connexion/endpoint").permitAll()
