...
public class SppotiBeanUtils
{
	 ...
	 *
	 * @param dest
	 * 		Objet de destination des données à mapper
	 * @param orig
	 * 		Objet contenant les données à mapper
	 */
	public static void copyProperties(final Object dest, final Object orig)
	{
		try {
			...
			throw new UnsupportedOperationException("Impossible de copier les deux beans", exception);
		}
	}
	 ...
	 * 		Objet contenant les données à mapper
	 * @param <B>
	 * 		La classe de l'objet à instancier
	 *
