...
public abstract class AbstractTransformerImpl<T extends AbstractCommonDTO, E extends AbstractCommonEntity>
        implements CommonTransformer<T, E> {
    ...
    public E dtoToModel(final T dto) {
        ...
        try {
            ...
            throw new BusinessGlobalException(
                    "Erreur lors de l'instantiation de l'entité Java par réflexion.");
        }
        if (dto != null) {
    ...
    public T modelToDto(final E model) {
        ...
        try {
            ...
            dto = clazz.newInstance();
                ...
                | IllegalAccessException exception) {
            throw new BusinessGlobalException(
                    "Erreur lors de l'instantiation du dto Java par réflexion.");
        }
