...
public interface PostBusinessService extends AbstractBusinessService
{
	...
	void updatePost(EditHistoryEntity postEditRow, SortedSet<AddressEntity> postEditAddress, String postId);
	...
	List<PostEntity> findAllPosts(Long userLongId, String userIntId, List visibility, int page);
	
	boolean isTargetUserFriendOfMe(String connectedUserUuid, String friendId);
	
	List<PostDTO> getAllUserPosts(Long connectedUserId, String connectedUserUuid, String userID, int page);
