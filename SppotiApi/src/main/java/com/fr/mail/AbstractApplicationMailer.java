 ...
 **/
@Component
public abstract class AbstractApplicationMailer
{
    ...
    protected static Logger LOGGER = LoggerFactory.getLogger(AbstractApplicationMailer.class);

    private final JavaMailSender sender;

    @Autowired
    public AbstractApplicationMailer(JavaMailSender sender) {
        this.sender = sender;
    }
