 ...
 */
@Entity @Table(name = "SPPOTI_MEMBER") public class SppotiMember
        extends AbstractCommonEntity
{
    ...
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "sppoti_id") private SppotiEntity sppoti;

    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "sppoter_id")
