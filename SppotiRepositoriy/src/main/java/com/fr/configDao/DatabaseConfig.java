...
//@PropertySources({ @PropertySource("classpath:hibernate.properties"),
...
//
//	@Bean
//	public LocalSessionFactoryBean sessionFactory() {// sprind ORM
//		LocalSessionFactoryBean sessionFactory = new LocalSessionFactoryBean();
//		sessionFactory.setDataSource(dataSource());
//		sessionFactory.setPackagesToScan(new String[] { "com.spooti.pojos" });
//		sessionFactory.setHibernateProperties(hibernateProperties());
//		return sessionFactory;
//	}
//
//	@Bean
//	public DataSource dataSource() {// Loading database information
...
//	@Bean
//	@Autowired
//	public HibernateTransactionManager transactionManager(SessionFactory s) {// Spring
//																				// ORM
